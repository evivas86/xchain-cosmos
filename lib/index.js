...
const AssetAtom = { chain: xchainUtil.Chain.Cosmos, symbol: 'ATOM', ticker: 'ATOM', synth: false };
const AssetMuon = { chain: xchainUtil.Chain.Cosmos, symbol: 'MUON', ticker: 'MUON', synth: false };
 ...
 */
const isMsgSend = (msg) => (msg === null || msg === void 0 ? void 0 : msg.amount) !== undefined &&
    (msg === null || msg === void 0 ? void 0 : msg.from_address) !== undefined &&
    (msg === null || msg === void 0 ? void 0 : msg.to_address) !== undefined;
/**
 ...
 * @returns {boolean} `true` or `false`.
 */
const isMsgMultiSend = (msg) => (msg === null || msg === void 0 ? void 0 : msg.inputs) !== undefined &&
    (msg === null || msg === void 0 ? void 0 : msg.outputs) !== undefined;
/**
...
const getCoinAmount = (coins) => {
    return coins
        ? coins
            .map((coin) => xchainUtil.baseAmount(coin.amount || 0, DECIMAL))
            .reduce((acc, cur) => xchainUtil.baseAmount(acc.amount().plus(cur.amount()), DECIMAL), xchainUtil.baseAmount(0, DECIMAL))
        : xchainUtil.baseAmount(0, DECIMAL);
};
/**
 ...
 */
const getTxsFromHistory = (txs, mainAsset) => {
    return txs.reduce((acc, tx) => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        let msgs;
        if (tx.tx.body === undefined) {
            msgs = core.cosmosclient.codec.packAnyFromCosmosJSON(tx.tx).msg;
        }
        else {
            msgs = core.cosmosclient.codec.packAnyFromCosmosJSON(tx.tx.body.messages);
        }
        const from = [];
        const to = [];
        msgs.map((msg) => {
            if (isMsgSend(msg)) {
                ...
                from.forEach((value, index) => {
                    if (value.from === msgSend.from_address)
                        from_index = index;
                });
                if (from_index === -1) {
                    from.push({
                ...
                to.forEach((value, index) => {
                    if (value.to === msgSend.to_address)
                        to_index = index;
                });
                if (to_index === -1) {
                    to.push({
...
const DEFAULT_FEE = new core.proto.cosmos.tx.v1beta1.Fee({
    amount: [],
    gas_limit: core.cosmosclient.Long.fromString('300000'),
});
class CosmosSDKClient {
    // by default, cosmos chain
    constructor({ server, chainId, prefix = 'cosmos' }) {
        this.prefix = '';
        this.server = server;
        this.chainId = chainId;
        this.sdk = new core.cosmosclient.CosmosSDK(server, this.chainId);
    ...
    setPrefix() {
        core.cosmosclient.config.setBech32Prefix({
            accAddr: this.prefix,
    ...
    getAddressFromPrivKey(privkey) {
        this.setPrefix();
        return core.cosmosclient.AccAddress.fromPublicKey(privkey.pubKey()).toString();
    }
    getAddressFromMnemonic(mnemonic, derivationPath) {
        this.setPrefix();
        const privKey = this.getPrivKeyFromMnemonic(mnemonic, derivationPath);
        return core.cosmosclient.AccAddress.fromPublicKey(privKey.pubKey()).toString();
    }
    getPrivKeyFromMnemonic(mnemonic, derivationPath) {
        this.setPrefix();
        ...
        return new core.proto.cosmos.crypto.secp256k1.PrivKey({ key: child.privateKey });
    }
    checkAddress(address) {
        ...
        if (!address.startsWith(this.prefix))
            return false;
        try {
            return core.cosmosclient.AccAddress.fromString(address).toString() === address;
        }
        catch (err) {
            return false;
        }
    }
    getUnsignedTxBody({ from, to, amount, asset, memo = '' }) {
        const msgSend = new core.proto.cosmos.bank.v1beta1.MsgSend({
            from_address: from,
            to_address: to,
            amount: [
                {
        ...
        return new core.proto.cosmos.tx.v1beta1.TxBody({
            messages: [core.cosmosclient.codec.packAny(msgSend)],
            memo,
        });
    }
    getBalance(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield core.rest.bank.allBalances(this.sdk, accAddress);
            return response.data.balances;
        });
    }
    getAccount(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield core.rest.auth
                .account(this.sdk, address)
                .then((res) => res.data.account && core.cosmosclient.codec.unpackCosmosAny(res.data.account))
                .catch((_) => undefined);
            if (!(account instanceof core.proto.cosmos.auth.v1beta1.BaseAccount)) {
                throw Error('could not get account');
            }
            return account;
        });
    }
    searchTx({ messageAction, messageSender, page, limit }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.setPrefix();
            return (yield axios__default['default'].get(`${this.server}/cosmos/tx/v1beta1/txs?${getQueryString(queryParameter)}`))
                .data;
        });
    }
    searchTxFromRPC({ messageAction, messageSender, transferSender, transferRecipient, page, limit, txMinHeight, txMaxHeight, rpcEndpoint, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const queryParameter = [];
            if (messageAction !== undefined) {
            ...
            const response = (yield axios__default['default'].get(`${rpcEndpoint}/tx_search?${searchParameter.join('&')}`)).data;
    ...
    txsHashGet(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            this.setPrefix();
            return (yield axios__default['default'].get(`${this.server}/cosmos/tx/v1beta1/txs/${hash}`)).data.tx_response;
        });
    }
    transfer({ privkey, from, to, amount, asset, memo = '', fee = DEFAULT_FEE }) {
        return __awaiter(this, void 0, void 0, function* () {
            this.setPrefix();
            const msgSend = new core.proto.cosmos.bank.v1beta1.MsgSend({
                from_address: from,
            ...
            const signer = core.cosmosclient.AccAddress.fromPublicKey(pubKey);
            const account = yield this.getAccount(signer);
            const txBody = new core.proto.cosmos.tx.v1beta1.TxBody({
                messages: [core.cosmosclient.codec.packAny(msgSend)],
                memo,
            });
            const authInfo = new core.proto.cosmos.tx.v1beta1.AuthInfo({
                signer_infos: [
                    {
                        public_key: core.cosmosclient.codec.packAny(pubKey),
                        mode_info: {
                            single: {
            ...
            const txBuilder = new core.cosmosclient.TxBuilder(this.sdk, txBody, authInfo);
            return this.signAndBroadcast(txBuilder, privkey, account);
        });
    }
    transferSignedOffline({ privkey, from, from_account_number = '0', from_sequence = '0', to, amount, asset, memo = '', fee = DEFAULT_FEE, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const txBody = this.getUnsignedTxBody({ from, to, amount, asset, memo });
            const authInfo = new core.proto.cosmos.tx.v1beta1.AuthInfo({
                signer_infos: [
                    {
                        public_key: core.cosmosclient.codec.packAny(privkey.pubKey()),
                        mode_info: {
                            single: {
                                mode: core.proto.cosmos.tx.signing.v1beta1.SignMode.SIGN_MODE_DIRECT,
                            },
                        },
                        sequence: core.cosmosclient.Long.fromString(from_sequence),
                    },
                ],
                fee,
            });
    ...
    signAndBroadcast(txBuilder, privKey, signerAccount) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            txBuilder.addSignature(privKey.sign(signDocBytes));
            // broadcast
            const res = yield core.rest.tx.broadcastTx(this.sdk, {
                tx_bytes: txBuilder.txBytes(),
                mode: core.rest.tx.BroadcastTxMode.Sync,
            });
            if (((_b = (_a = res === null || res === void 0 ? void 0 : res.data) === null || _a === void 0 ? void 0 : _a.tx_response) === null || _b === void 0 ? void 0 : _b.code) !== 0) {
                throw new Error('Error broadcasting: ' + ((_d = (_c = res === null || res === void 0 ? void 0 : res.data) === null || _c === void 0 ? void 0 : _c.tx_response) === null || _d === void 0 ? void 0 : _d.raw_log));
            }
            if (!((_e = res.data) === null || _e === void 0 ? void 0 : _e.tx_response.txhash) || ((_f = res.data) === null || _f === void 0 ? void 0 : _f.tx_response.txhash) === '') {
...
class Client extends xchainClient.BaseXChainClient {
    ...
    getBalance(address, assets) {
        return __awaiter(this, void 0, void 0, function* () {
            const balances = yield this.getSDKClient().getBalance(address);
    ...
    getTransactions(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mainAsset = this.getMainAsset();
            const txHistory = yield this.getSDKClient().searchTx({
                messageAction,
            ...
            return {
                total: parseInt(((_a = txHistory.pagination) === null || _a === void 0 ? void 0 : _a.total) || '0'),
    ...
    getTransactionData(txId) {
        return __awaiter(this, void 0, void 0, function* () {
            const txResult = yield this.getSDKClient().txsHashGet(txId);
     ...
     */
    transferOffline({ walletIndex, asset, amount, recipient, memo, from_account_number, from_sequence, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const fromAddressIndex = walletIndex || 0;
            const mainAsset = this.getMainAsset();
            return yield this.getSDKClient().transferSignedOffline({
                privkey: this.getPrivateKey(fromAddressIndex),
                from: this.getAddress(fromAddressIndex),
                from_account_number,
                from_sequence,
