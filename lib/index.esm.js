...
import { TxType, FeeType, BaseXChainClient, Network } from '@xchainjs/xchain-client';
...
const AssetMuon = { chain: Chain.Cosmos, symbol: 'MUON', ticker: 'MUON', synth: false };
...
class CosmosSDKClient {
    ...
    getBalance(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield rest.bank.allBalances(this.sdk, accAddress);
            return response.data.balances;
        });
    }
    getAccount(address) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield rest.auth
    ...
    searchTx({ messageAction, messageSender, page, limit }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.setPrefix();
            return (yield axios.get(`${this.server}/cosmos/tx/v1beta1/txs?${getQueryString(queryParameter)}`))
                .data;
        });
    }
    searchTxFromRPC({ messageAction, messageSender, transferSender, transferRecipient, page, limit, txMinHeight, txMaxHeight, rpcEndpoint, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = (yield axios.get(`${rpcEndpoint}/tx_search?${searchParameter.join('&')}`)).data;
    ...
    txsHashGet(hash) {
        return __awaiter(this, void 0, void 0, function* () {
            this.setPrefix();
            return (yield axios.get(`${this.server}/cosmos/tx/v1beta1/txs/${hash}`)).data.tx_response;
        });
    }
    ...
    signAndBroadcast(txBuilder, privKey, signerAccount) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            txBuilder.addSignature(privKey.sign(signDocBytes));
            // broadcast
            const res = yield rest.tx.broadcastTx(this.sdk, {
...
export { AssetAtom, AssetMuon, Client, CosmosSDKClient, DECIMAL, getAsset, getDefaultFees, getDenom, getPrefix, getQueryString, getTxsFromHistory, isMsgMultiSend, isMsgSend };
